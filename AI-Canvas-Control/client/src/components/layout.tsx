    ...
    <div className="min-h-screen bg-background flex flex-col">
      <nav className="border-b border-border/50 bg-background/80 backdrop-blur-sm sticky top-0 z-50">
        <div className="max-w-5xl mx-auto px-4 flex items-center justify-between h-12">
          <span className="text-sm font-semibold tracking-tight" data-testid="text-brand">LumenDust</span>
          <div className="flex items-center gap-1">
            ...
            <Popover>
              ...
              <PopoverContent className="w-80 p-3" align="end" data-testid="settings-popup">
                    ...
                    <div className="space-y-2">
                      <div>
                        ...
                        <input
                          ...
                          className="w-full h-8 px-2 rounded-md border border-border/50 bg-muted/30 text-xs text-foreground placeholder:text-muted-foreground/40 outline-none focus:border-primary/50"
                          data-testid="input-download-prefix"
                        />
                  ...
                  <div className="border-t border-border/30 pt-2">
                    ...
                    <div className="space-y-1">
                      <div className="flex items-center justify-between">
                        <span className="text-xs text-muted-foreground" data-testid="text-model-nb2">NanoBanana 2</span>
                        <span className="text-[10px] text-muted-foreground/60">联网 · 思考 · 14比例</span>
                      </div>
                      <div className="flex items-center justify-between">
                        <span className="text-xs text-muted-foreground" data-testid="text-model-pro">NanoBanana Pro</span>
