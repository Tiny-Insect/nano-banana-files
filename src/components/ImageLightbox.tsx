...
export default function ImageLightbox({ image, mode, onClose, isReGenerating = false, onUsePrompt, onReEdit, onReGenerate, onLocate, onDelete, onRestore }: ImageLightboxProps) {
